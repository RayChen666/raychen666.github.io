...
summary: "Designed a full-stack AR drone teleoperation system, combining spatial user interfaces and live hardware control, 
...
<SmartLink suffixIcon="arrowUpRightFromSquare" href="https://github.com/RayChen666/AR-Tello-Simulator">
...
<figure style={{ maxWidth: '720px', margin: '2rem auto' }}>
   <img src="/images/projects/project-01/arTelloSimulator-pipeline.jpg" 
    alt="Control panel layout" 
    width="100%"
    style={{ borderRadius: '20px' }}
  />
  <figcaption style={{ fontSize: '1.0rem', color: '#aaa', marginTop: '0.5rem' }}>Pipeline of the distributed system and workflow.</figcaption>
</figure>
...
<figure style={{ maxWidth: '720px', margin: '2rem auto' }}>
   <img src="/images/projects/project-01/arTelloSimulator-control-1.jpg" 
    alt="Control panel layout" 
    width="100%"
    style={{ borderRadius: '20px' }}
  />
  <figcaption style={{ fontSize: '1.0rem', color: '#aaa', marginTop: '0.5rem' }}>User interface example (to view full interaction workflow, check out demo video above).</figcaption>
</figure>
