...
images:
  - "/images/projects/project-01/Project-Demo-Video.mp4"
  - "/images/projects/project-01/project-intro.jpg"
  - "/images/projects/project-01/Pipeline.jpg"
...
team:
  - name: "Ray Chen"
    ...
    linkedIn: "https://www.linkedin.com/in/raychen666666/"
...
the KeyPointClassifier and PointHistoryClassifier models for gesture classification.

The evaluation of the KeyPointClassifier model involved data preparation, model training, and model evaluation. 
A dataset of hand gestures was collected, consisting of various hand poses such as open hand, closed hand, pointing 
gestures, and OK sign. The hand landmarks were extracted using the MediaPipe hand detection module. The PointHistoryClassifier 
model is designed to classify finger gestures based on a sequence of point histories. The evaluation of the PointHistoryClassifier 
model followed a similar process as the KeyPointClassifier model. A dataset of finger gestures was collected, consisting of various 
finger movements such as swiping, tapping, and drawing patterns. The point histories were recorded using the MediaPipe hand tracking 
module.
...
achieved an average frame rate of 30 frames per second (FPS) on a standard desktop computer, indicating smooth and responsive gesture 
...
into separate modules. The HandDetectionModule.py is responsible for detecting hands in 
...
HandLandmarkModule.py, which applies the KeyPointClassifier and PointHistoryClassifier models to classify the hand gestures and finger movements.

The classified gestures are mapped to specific drone control commands in the DroneControlModule.py. This module establishes a connection with the 
...
without quitting the program. After that by pressing ”d”, the program will call the DroneConnectionTest.py to run the drone connection test. If the drone connection 
