...
summary: "Designed a real-time computer vision pipeline integrating hand landmark extraction (MediaPipe, OpenCV) with TensorFlow 
...
<SmartLink suffixIcon="arrowUpRightFromSquare" href="https://github.com/RayChen666/HandGestureDJITello">
  <Text variant="body-default-m">Project code</Text>
</SmartLink>

## Overview

A real-time hand gesture recognition system that enables intuitive, screenless control of DJI Tello drones through 
natural hand movements. Built using MediaPipe for hand tracking, TensorFlow Lite for gesture classification, and 
OpenCV for the control interface - achieving 30 FPS performance with minimal latency for responsive flight control.
...
<figure style={{ maxWidth: '720px', margin: '2rem auto' }}>
   <img src="/images/projects/project-01/handgestureTello-project-intro.jpg" 
    alt="Control panel layout" 
    width="100%"
    style={{ borderRadius: '20px' }}
  />
  <figcaption style={{ fontSize: '1.0rem', color: '#aaa', marginTop: '0.5rem' }}></figcaption>
</figure>
...
<figure style={{ maxWidth: '720px', margin: '2rem auto' }}>
   <img src="/images/projects/project-01/handgestureTello-Pipeline.jpg" 
    alt="Control panel layout" 
    width="100%"
    style={{ borderRadius: '20px' }}
  />
